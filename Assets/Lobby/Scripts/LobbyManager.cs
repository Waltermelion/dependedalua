...
public class LobbyManager : MonoBehaviour {
        ...
        if (joinedLobby != null) {
            ...
            if (lobbyPollTimer < 0f) {
                ...
                if (joinedLobby.Data[KEY_START_GAME].Value != "0") {
                    if (!IsLobbyHost()) {
                        TesteRelay.Instance.JoinRelay(joinedLobby.Data[KEY_START_GAME].Value);
                    }
        ...
        try {
            ...
            CreateLobbyOptions options = new CreateLobbyOptions {
                ...
                Data = new Dictionary<string, DataObject> {
                    ...
                    { KEY_CODE, new DataObject(DataObject.VisibilityOptions.Member, relayJoinCode)}
                }
            };
    ...
    public async void JoinLobbyByCode(string lobbyCode) {
        ...
        string relayJoinCode = lobby.Data[KEY_CODE].Value;
    ...
    public async void StartGame() {
        if (IsLobbyHost()) {
            try {
                ...
                string relayCode = await TesteRelay.Instance.CreateRelay();
